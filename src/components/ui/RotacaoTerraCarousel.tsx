...
const images = [
  "/images/rotacao-terra/1.jpg",
  "/images/rotacao-terra/2.jpg",
  "/images/rotacao-terra/3.jpg",
  "/images/rotacao-terra/4.jpg",
  "/images/rotacao-terra/5.jpg",
  "/images/rotacao-terra/6.jpg",
  "/images/rotacao-terra/7.jpg",
  "/images/rotacao-terra/8.jpg",
  "/images/rotacao-terra/9.jpg",
  "/images/rotacao-terra/10.jpg",
  "/images/rotacao-terra/11.jpg",
  "/images/rotacao-terra/12.jpg",
  "/images/rotacao-terra/13.jpg",
  "/images/rotacao-terra/14.jpg",
  "/images/rotacao-terra/15.jpg",
];

export default function RotacaoTerraCarousel() {
    ...
    <div className="w-full max-w-4xl mx-auto">
      ...
      <div className="relative rounded-2xl overflow-hidden bg-slate-900/50 border border-slate-700/50 shadow-2xl">
        ...
        <div className="relative aspect-[4/3] md:aspect-video">
          ...
          <img
            src={images[current]}
            alt={`Rotação da Terra - Uma Jornada Científica - Página ${current + 1}`}
