    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900">
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative container mx-auto px-4 py-12">
            ...
            <p className="text-xl text-gray-300 max-w-3xl leading-relaxed">
              Descubra como a <span className="text-cyan-400 font-semibold">Terra</span> é formada 
              por camadas internas — <span className="text-amber-400">crosta</span>, 
              <span className="text-orange-400"> manto</span> e <span className="text-red-400">núcleo</span> — 
        ...
        <section className="container mx-auto px-4 py-8">
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-white flex items-center gap-3">
              <Md3dRotation className="text-cyan-400" />
          ...
          {/* Embed do Sketchfab */}
          <div className="relative w-full rounded-2xl overflow-hidden border border-slate-700/50 shadow-2xl bg-slate-950">
            <iframe
          ...
          <div className="mt-4 flex flex-wrap items-center justify-between gap-4">
            ...
            <a 
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-slate-800/50 hover:bg-slate-700/50 rounded-lg text-sm text-slate-300 hover:text-white transition-colors border border-slate-700/50"
            >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
            {dadosCientificos.map((dado, index) => (
              ...
              >
                ...
                <p className="text-gray-400 text-sm mt-1">{dado.label}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="container mx-auto px-4 py-12">
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-white mb-4 flex items-center gap-3">
              <GiEarthAmerica className="text-red-400" />
              As Camadas da Terra
            </h2>
            <p className="text-slate-400 max-w-3xl">
          ...
          <div className="bg-gradient-to-r from-slate-800 to-slate-900 rounded-2xl p-8 border border-slate-700/50">
            ...
            <div className="space-y-4">
              ...
              <div className="relative h-16 rounded-xl overflow-hidden flex">
                ...
                {/* Núcleo Externo */}
                <div className="h-full bg-gradient-to-r from-yellow-500 to-amber-500 flex items-center justify-center" style={{ width: '35%' }}>
                  <span className="text-white text-sm font-bold">Núcleo Externo (35%)</span>
                </div>
                {/* Núcleo Interno */}
                <div className="h-full bg-gradient-to-r from-red-500 to-orange-500 flex items-center justify-center" style={{ width: '19%' }}>
        ...
        <section className="container mx-auto px-4 py-12">
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-white mb-4 flex items-center gap-3">
              <GiMagnet className="text-purple-400" />
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {curiosidades.map((curiosidade, index) => (
              <div 
                key={index}
                className="bg-slate-800/50 rounded-2xl p-6 border border-slate-700/50 hover:border-purple-500/30 transition-colors"
              >
                <div className="flex items-center gap-3 mb-4">
                  <span className="text-3xl">{curiosidade.icon}</span>
                  <h3 className="text-lg font-bold text-white">{curiosidade.titulo}</h3>
                </div>
        ...
        <section className="container mx-auto px-4 py-12">
          <div className="bg-gradient-to-br from-slate-800/80 via-slate-900/90 to-slate-800/80 rounded-2xl p-8 md:p-10 border border-slate-700/50">
            <div className="mb-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-500/20 rounded-full text-emerald-400 text-sm mb-4">
              ...
              <div className="space-y-6">
                <div className="bg-slate-800/60 rounded-xl p-6 border border-slate-700/40">
                  ...
                  <p className="text-slate-300 leading-relaxed mb-4">
                    ...
                    <strong className="text-white"> ondas sísmicas</strong> geradas por terremotos para "enxergar" 
                    dentro da Terra. Existem dois tipos principais:
                  </p>
                  <ul className="space-y-3 text-sm">
                    <li className="flex items-start gap-3 text-slate-300">
                      <span className="text-cyan-400 font-bold mt-1">P</span>
                      <div>
                        <strong className="text-white">Ondas Primárias (P)</strong> — Compressão, como som. 
                        Viajam por sólidos e líquidos. Velocidade: 6-14 km/s.
                      </div>
                    </li>
                    <li className="flex items-start gap-3 text-slate-300">
                      <span className="text-purple-400 font-bold mt-1">S</span>
                      <div>
                        <strong className="text-white">Ondas Secundárias (S)</strong> — Cisalhamento, ondulação lateral. 
                        <em className="text-amber-400"> NÃO atravessam líquidos!</em> Velocidade: 3-7 km/s.
                      </div>
                    </li>
                  </ul>
                  <p className="text-slate-400 text-sm mt-4 italic border-t border-slate-700/50 pt-4">
                ...
                <div className="bg-slate-800/60 rounded-xl p-6 border border-slate-700/40">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 bg-slate-900/50 rounded-lg">
                      <div>
                        <p className="text-white font-medium">Descontinuidade de Mohorovičić</p>
                        <p className="text-slate-400 text-xs">Andrija Mohorovičić, 1909</p>
                      </div>
                      <span className="text-cyan-400 font-mono">~35 km</span>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-slate-900/50 rounded-lg">
                      <div>
                        <p className="text-white font-medium">Descontinuidade de Gutenberg</p>
                        <p className="text-slate-400 text-xs">Beno Gutenberg, 1914</p>
                      </div>
                      <span className="text-orange-400 font-mono">2.900 km</span>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-slate-900/50 rounded-lg">
                      <div>
                        <p className="text-white font-medium">Descontinuidade de Lehmann</p>
                        <p className="text-slate-400 text-xs">Inge Lehmann, 1936</p>
                      </div>
                      <span className="text-red-400 font-mono">5.150 km</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="bg-slate-800/60 rounded-xl p-6 border border-slate-700/40">
                  ...
                  <div className="space-y-3 text-sm">
                    <div className="p-3 bg-gradient-to-r from-amber-900/30 to-transparent rounded-lg border-l-4 border-amber-500">
                      <p className="text-white font-medium mb-1">Crosta</p>
                      <p className="text-slate-400">Oxigênio (46%), Silício (28%), Alumínio (8%), Ferro (5%)</p>
                    </div>
                    <div className="p-3 bg-gradient-to-r from-orange-900/30 to-transparent rounded-lg border-l-4 border-orange-500">
                      <p className="text-white font-medium mb-1">Manto</p>
                      <p className="text-slate-400">Silicatos ricos em Mg e Fe: olivina [(Mg,Fe)₂SiO₄] e piroxênios</p>
                    </div>
                    <div className="p-3 bg-gradient-to-r from-yellow-900/30 to-transparent rounded-lg border-l-4 border-yellow-500">
                      <p className="text-white font-medium mb-1">Núcleo</p>
                      <p className="text-slate-400">~85% Ferro, ~10% Níquel, ~5% elementos leves (S, O, Si, H)</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-slate-800/60 rounded-xl p-6 border border-slate-700/40">
                  ...
                  <p className="text-slate-300 leading-relaxed mb-4">
                    O campo magnético terrestre é gerado pelo <strong className="text-white">efeito dínamo</strong> no 
                  ...
                  <div className="grid grid-cols-2 gap-4 text-center">
                    <div className="p-4 bg-slate-900/50 rounded-xl">
                      <p className="text-3xl font-bold text-cyan-400">25-65</p>
                      <p className="text-slate-400 text-xs">μT na superfície</p>
                    </div>
                    <div className="p-4 bg-slate-900/50 rounded-xl">
                      <p className="text-3xl font-bold text-purple-400">~780k</p>
                      <p className="text-slate-400 text-xs">anos desde última inversão</p>
                    </div>
                  </div>
                ...
                <div className="bg-gradient-to-r from-indigo-900/40 to-purple-900/40 rounded-xl p-6 border border-indigo-500/30">
                  ...
                  <p className="text-slate-300 text-sm leading-relaxed">
                    O interior da Terra libera <strong className="text-white">~47 TW de calor</strong> (equivalente a 
          ...
          <div className="bg-gradient-to-r from-slate-800 to-slate-900 rounded-2xl p-8 border border-slate-700/50">
            ...
            <div className="grid md:grid-cols-4 gap-4">
              <div className="text-center p-4 bg-slate-700/30 rounded-xl">
                ...
                <p className="text-white font-bold">Terra</p>
                <p className="text-cyan-400 text-sm">Núcleo: Fe + Ni</p>
                <p className="text-slate-400 text-xs">Manto ativo</p>
              </div>
              <div className="text-center p-4 bg-slate-700/30 rounded-xl">
                <span className="text-3xl mb-2 block">🔴</span>
                <p className="text-white font-bold">Marte</p>
                <p className="text-orange-400 text-sm">Núcleo menor</p>
                <p className="text-slate-400 text-xs">Sem campo magnético</p>
              </div>
              <div className="text-center p-4 bg-slate-700/30 rounded-xl">
                <span className="text-3xl mb-2 block">🟠</span>
                <p className="text-white font-bold">Vênus</p>
                <p className="text-yellow-400 text-sm">Similar à Terra</p>
                <p className="text-slate-400 text-xs">Sem placas tectônicas</p>
              </div>
              <div className="text-center p-4 bg-slate-700/30 rounded-xl">
                <span className="text-3xl mb-2 block">☿️</span>
                <p className="text-white font-bold">Mercúrio</p>
                <p className="text-purple-400 text-sm">70% núcleo!</p>
                <p className="text-slate-400 text-xs">Maior proporção</p>
              </div>
            </div>
          </div>
        </section>
