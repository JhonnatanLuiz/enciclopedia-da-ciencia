...
export default function IntroducaoPlanetaTerra() {
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-gray-50 via-blue-50 to-gray-100 dark:from-slate-900 dark:via-blue-950 dark:to-slate-900 text-gray-900 dark:text-gray-100 transition-colors duration-300">
        {/* Header de Navegação */}
        <nav className="sticky top-0 z-50 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border-b border-blue-200 dark:border-blue-500/20">
          <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2 text-gray-600 dark:text-slate-400">
                ...
                <span className="text-sm text-blue-600 dark:text-blue-300">Introdução</span>
              </div>
              <ThemeToggle />
            </div>
          </div>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 py-16 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-500/20 rounded-full border border-blue-500/30">
                <MdOutlineScience className="text-blue-600 dark:text-blue-400" />
                <span className="text-blue-600 dark:text-blue-300 text-sm font-medium">Subcapítulo 1</span>
              </div>
              
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold">
                <span className="bg-gradient-to-r from-blue-500 via-cyan-500 to-teal-500 dark:from-blue-400 dark:via-cyan-400 dark:to-teal-400 bg-clip-text text-transparent">
                  Introdução ao
                </span>
                <br />
                <span className="text-gray-900 dark:text-white">Planeta Terra</span>
              </h1>

              <p className="text-lg text-gray-700 dark:text-slate-300 leading-relaxed max-w-xl">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="px-3 py-1 bg-blue-500/20 text-blue-600 dark:text-blue-300 rounded-full text-sm border border-blue-500/30">
                  Geofísica
                </span>
                <span className="px-3 py-1 bg-cyan-500/20 text-cyan-600 dark:text-cyan-300 rounded-full text-sm border border-cyan-500/30">
                  Astronomia
                </span>
                <span className="px-3 py-1 bg-teal-500/20 text-teal-600 dark:text-teal-300 rounded-full text-sm border border-teal-500/30">
                  Ciências da Terra
                </span>
              </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-3 mb-8">
              <div className="p-3 bg-blue-500/20 rounded-xl">
                <GiEarthAmerica className="text-3xl text-blue-600 dark:text-blue-400" />
              </div>
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white">O Que É a Terra?</h2>
            </div>

            <div className="space-y-6 text-gray-700 dark:text-slate-300 leading-relaxed">
              <p className="text-lg">
                A <strong className="text-blue-600 dark:text-blue-400">Terra</strong> é o terceiro planeta a partir do Sol 
                e o quinto maior do Sistema Solar. Com um diâmetro equatorial de aproximadamente 
                <strong className="text-cyan-600 dark:text-cyan-400"> 12.756 quilômetros</strong>, ela é o maior dos planetas 
                rochosos (telúricos) e o único corpo celeste conhecido que sustenta vida.
              </p>

              <p>
                Formada há cerca de <strong className="text-blue-600 dark:text-blue-400">4,54 bilhões de anos</strong> a partir 
              ...
              <p>
                ...
                <strong className="text-cyan-600 dark:text-cyan-400"> 149,6 milhões de km</strong> (1 Unidade Astronômica), 
                completando uma volta a cada <strong className="text-blue-600 dark:text-blue-400">365,256 dias</strong>. 
              ...
              <div className="p-6 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 rounded-2xl border border-blue-500/20 mt-8">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">💡 Por que "Terra"?</h3>
                <p>
                  O nome "Terra" deriva do latim <em className="text-blue-600 dark:text-blue-300">terra</em>, que significa 
                  "solo" ou "chão". Em inglês, <em className="text-cyan-600 dark:text-cyan-300">Earth</em> vem do germânico 
        ...
        <section className="py-20 px-4 bg-gray-200/50 dark:bg-slate-800/30">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">🌍 A Terra em Imagens</h2>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-red-500/20 rounded-full border border-red-500/30 mb-4">
                ...
                <span className="text-red-600 dark:text-red-300 text-sm font-medium">Vídeo Exclusivo</span>
              </div>
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">🎬 Planeta Terra: Uma Biografia</h2>
              <p className="text-gray-600 dark:text-slate-400 max-w-2xl mx-auto">
            ...
            {/* Info do vídeo */}
            <div className="mt-6 p-4 bg-gray-200/70 dark:bg-slate-800/50 rounded-xl border border-gray-300/50 dark:border-slate-700/50">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-full flex items-center justify-center">
                  <span className="text-white font-bold text-sm">EC</span>
                </div>
                <div>
                  <h4 className="text-gray-900 dark:text-white font-medium">Enciclopédia da Ciência</h4>
                  <p className="text-gray-500 dark:text-slate-500 text-sm">Conteúdo original do canal</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex items-center gap-3 mb-12 justify-center">
              <div className="p-3 bg-cyan-500/20 rounded-xl">
                <MdOutlineScience className="text-3xl text-cyan-600 dark:text-cyan-400" />
              </div>
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Dados Científicos Fundamentais</h2>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="p-6 bg-gradient-to-br from-blue-500/10 to-blue-600/5 rounded-2xl border border-blue-500/20">
                ...
                <ul className="space-y-2 text-gray-700 dark:text-slate-300 text-sm">
                  <li><span className="text-gray-500 dark:text-slate-500">Diâmetro equatorial:</span> <strong>12.756 km</strong></li>
                  <li><span className="text-gray-500 dark:text-slate-500">Diâmetro polar:</span> <strong>12.714 km</strong></li>
                  <li><span className="text-gray-500 dark:text-slate-500">Circunferência:</span> <strong>40.075 km</strong></li>
                  <li><span className="text-gray-500 dark:text-slate-500">Área de superfície:</span> <strong>510,1 milhões km²</strong></li>
                  <li><span className="text-gray-500 dark:text-slate-500">Volume:</span> <strong>1,083 × 10¹² km³</strong></li>
                </ul>
              </div>
              ...
              <div className="p-6 bg-gradient-to-br from-cyan-500/10 to-cyan-600/5 rounded-2xl border border-cyan-500/20">
                ...
                <ul className="space-y-2 text-gray-700 dark:text-slate-300 text-sm">
                  <li><span className="text-gray-500 dark:text-slate-500">Massa:</span> <strong>5,972 × 10²⁴ kg</strong></li>
                  <li><span className="text-gray-500 dark:text-slate-500">Densidade média:</span> <strong>5,515 g/cm³</strong></li>
                  <li><span className="text-gray-500 dark:text-slate-500">Gravidade superficial:</span> <strong>9,807 m/s²</strong></li>
                  <li><span className="text-gray-500 dark:text-slate-500">Velocidade de escape:</span> <strong>11,186 km/s</strong></li>
                  <li><span className="text-gray-500 dark:text-slate-500">Achatamento:</span> <strong>0,003353</strong></li>
                </ul>
              </div>
              ...
              <div className="p-6 bg-gradient-to-br from-teal-500/10 to-teal-600/5 rounded-2xl border border-teal-500/20">
                ...
                <ul className="space-y-2 text-gray-700 dark:text-slate-300 text-sm">
                  <li><span className="text-gray-500 dark:text-slate-500">Semieixo maior:</span> <strong>149,598 × 10⁶ km</strong></li>
                  <li><span className="text-gray-500 dark:text-slate-500">Periélio:</span> <strong>147,09 × 10⁶ km</strong></li>
                  <li><span className="text-gray-500 dark:text-slate-500">Afélio:</span> <strong>152,10 × 10⁶ km</strong></li>
                  <li><span className="text-gray-500 dark:text-slate-500">Excentricidade:</span> <strong>0,0167</strong></li>
                  <li><span className="text-gray-500 dark:text-slate-500">Velocidade orbital:</span> <strong>29,78 km/s</strong></li>
                </ul>
              </div>
              ...
              <div className="p-6 bg-gradient-to-br from-indigo-500/10 to-indigo-600/5 rounded-2xl border border-indigo-500/20">
                ...
                <ul className="space-y-2 text-gray-700 dark:text-slate-300 text-sm">
                  <li><span className="text-gray-500 dark:text-slate-500">Período sideral:</span> <strong>23h 56m 4,1s</strong></li>
                  <li><span className="text-gray-500 dark:text-slate-500">Período solar:</span> <strong>24 horas</strong></li>
                  <li><span className="text-gray-500 dark:text-slate-500">Inclinação axial:</span> <strong>23,44°</strong></li>
                  <li><span className="text-gray-500 dark:text-slate-500">Vel. no equador:</span> <strong>1.674 km/h</strong></li>
                  <li><span className="text-gray-500 dark:text-slate-500">Direção:</span> <strong>Anti-horário (vista N)</strong></li>
                </ul>
              </div>
              ...
              <div className="p-6 bg-gradient-to-br from-orange-500/10 to-orange-600/5 rounded-2xl border border-orange-500/20">
                ...
                <ul className="space-y-2 text-gray-700 dark:text-slate-300 text-sm">
                  <li><span className="text-gray-500 dark:text-slate-500">Média global:</span> <strong>14°C (287 K)</strong></li>
                  <li><span className="text-gray-500 dark:text-slate-500">Máxima registrada:</span> <strong>56,7°C</strong></li>
                  <li><span className="text-gray-500 dark:text-slate-500">Mínima registrada:</span> <strong>-89,2°C</strong></li>
                  <li><span className="text-gray-500 dark:text-slate-500">Núcleo interno:</span> <strong>~5.400°C</strong></li>
                  <li><span className="text-gray-500 dark:text-slate-500">Núcleo externo:</span> <strong>~4.500°C</strong></li>
                </ul>
              </div>
              ...
              <div className="p-6 bg-gradient-to-br from-slate-500/10 to-slate-600/5 rounded-2xl border border-slate-500/20">
                ...
                <ul className="space-y-2 text-gray-700 dark:text-slate-300 text-sm">
                  <li><span className="text-gray-500 dark:text-slate-500">Nome:</span> <strong>Lua (Moon)</strong></li>
                  <li><span className="text-gray-500 dark:text-slate-500">Diâmetro:</span> <strong>3.474 km</strong></li>
                  <li><span className="text-gray-500 dark:text-slate-500">Distância média:</span> <strong>384.400 km</strong></li>
                  <li><span className="text-gray-500 dark:text-slate-500">Período orbital:</span> <strong>27,3 dias</strong></li>
                  <li><span className="text-gray-500 dark:text-slate-500">Razão Terra/Lua:</span> <strong>81:1 (massa)</strong></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="flex items-center gap-3 mb-12 justify-center">
              <div className="p-3 bg-orange-500/20 rounded-xl">
                <GiVolcano className="text-3xl text-orange-600 dark:text-orange-400" />
              </div>
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Estrutura Interna</h2>
            </div>

            <p className="text-center text-gray-700 dark:text-slate-300 mb-12 max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="p-6 bg-gradient-to-r from-amber-500/10 to-amber-600/5 rounded-2xl border border-amber-500/20">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-amber-600 dark:text-amber-400 mb-2">Crosta</h3>
                    <p className="text-gray-700 dark:text-slate-300 mb-3">
                      A camada mais externa e fina, dividida em <strong className="text-amber-600 dark:text-amber-300">crosta continental</strong> 
                      (30-70 km, rica em silício e alumínio — SiAl) e <strong className="text-amber-600 dark:text-amber-300">crosta oceânica</strong> 
                      (5-10 km, rica em silício e magnésio — SiMa). Representa apenas 1% do volume terrestre.
                    </p>
                    <div className="flex flex-wrap gap-2">
                      <span className="px-2 py-1 bg-amber-500/20 text-amber-600 dark:text-amber-300 rounded text-xs">Espessura: 5-70 km</span>
                      <span className="px-2 py-1 bg-amber-500/20 text-amber-600 dark:text-amber-300 rounded text-xs">Densidade: 2,7-3,0 g/cm³</span>
                      <span className="px-2 py-1 bg-amber-500/20 text-amber-600 dark:text-amber-300 rounded text-xs">Temperatura: até 400°C</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 bg-gradient-to-r from-orange-500/10 to-orange-600/5 rounded-2xl border border-orange-500/20">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-orange-600 dark:text-orange-400 mb-2">Manto</h3>
                    <p className="text-gray-700 dark:text-slate-300 mb-3">
                      A maior camada da Terra, composta principalmente por <strong className="text-orange-600 dark:text-orange-300">silicatos de ferro e magnésio</strong>. 
                    ...
                    <div className="flex flex-wrap gap-2">
                      <span className="px-2 py-1 bg-orange-500/20 text-orange-600 dark:text-orange-300 rounded text-xs">Espessura: ~2.900 km</span>
                      <span className="px-2 py-1 bg-orange-500/20 text-orange-600 dark:text-orange-300 rounded text-xs">Densidade: 3,4-5,6 g/cm³</span>
                      <span className="px-2 py-1 bg-orange-500/20 text-orange-600 dark:text-orange-300 rounded text-xs">Temperatura: 500-4.000°C</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 bg-gradient-to-r from-red-500/10 to-red-600/5 rounded-2xl border border-red-500/20">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-red-600 dark:text-red-400 mb-2">Núcleo Externo</h3>
                    <p className="text-gray-700 dark:text-slate-300 mb-3">
                      Camada líquida composta por <strong className="text-red-600 dark:text-red-300">ferro e níquel fundidos</strong>. 
                      Os movimentos de convecção neste "oceano de metal" geram o 
                      <strong className="text-red-600 dark:text-red-300"> campo magnético terrestre</strong> através do efeito dínamo — 
                      essencial para proteger a vida da radiação cósmica.
                    </p>
                    <div className="flex flex-wrap gap-2">
                      <span className="px-2 py-1 bg-red-500/20 text-red-600 dark:text-red-300 rounded text-xs">Espessura: ~2.200 km</span>
                      <span className="px-2 py-1 bg-red-500/20 text-red-600 dark:text-red-300 rounded text-xs">Densidade: 9,9-12,2 g/cm³</span>
                      <span className="px-2 py-1 bg-red-500/20 text-red-600 dark:text-red-300 rounded text-xs">Temperatura: 4.000-5.000°C</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 bg-gradient-to-r from-yellow-500/10 to-yellow-600/5 rounded-2xl border border-yellow-500/20">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-yellow-600 dark:text-yellow-400 mb-2">Núcleo Interno</h3>
                    <p className="text-gray-700 dark:text-slate-300 mb-3">
                      Uma esfera sólida de <strong className="text-yellow-600 dark:text-yellow-300">ferro cristalino</strong> com 
                    ...
                    <div className="flex flex-wrap gap-2">
                      <span className="px-2 py-1 bg-yellow-500/20 text-yellow-600 dark:text-yellow-300 rounded text-xs">Raio: ~1.220 km</span>
                      <span className="px-2 py-1 bg-yellow-500/20 text-yellow-600 dark:text-yellow-300 rounded text-xs">Densidade: 12,8-13,1 g/cm³</span>
                      <span className="px-2 py-1 bg-yellow-500/20 text-yellow-600 dark:text-yellow-300 rounded text-xs">Pressão: 330-360 GPa</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="flex items-center gap-3 mb-12 justify-center">
              <div className="p-3 bg-sky-500/20 rounded-xl">
                <FaWater className="text-3xl text-sky-600 dark:text-sky-400" />
              </div>
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Atmosfera Terrestre</h2>
            </div>
            ...
            <div className="p-6 bg-gradient-to-br from-sky-500/10 to-blue-500/10 rounded-2xl border border-sky-500/20 mb-8">
              <h3 className="text-xl font-semibold text-sky-600 dark:text-sky-400 mb-4">Composição Química</h3>
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="text-center p-4 bg-sky-500/10 rounded-xl">
                  <div className="text-3xl font-bold text-sky-600 dark:text-sky-400">78,08%</div>
                  <div className="text-gray-600 dark:text-slate-400">Nitrogênio (N₂)</div>
                </div>
                <div className="text-center p-4 bg-blue-500/10 rounded-xl">
                  <div className="text-3xl font-bold text-blue-600 dark:text-blue-400">20,95%</div>
                  <div className="text-gray-600 dark:text-slate-400">Oxigênio (O₂)</div>
                </div>
                <div className="text-center p-4 bg-indigo-500/10 rounded-xl">
                  <div className="text-3xl font-bold text-indigo-600 dark:text-indigo-400">0,93%</div>
                  <div className="text-gray-600 dark:text-slate-400">Argônio (Ar)</div>
                </div>
                <div className="text-center p-4 bg-purple-500/10 rounded-xl">
                  <div className="text-3xl font-bold text-purple-600 dark:text-purple-400">0,04%</div>
                  <div className="text-gray-600 dark:text-slate-400">CO₂ e outros</div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="p-4 bg-gradient-to-r from-blue-100/50 to-blue-200/30 dark:from-blue-900/30 dark:to-blue-800/20 rounded-xl border border-blue-500/20">
                <div className="flex justify-between items-center mb-2">
                  <h4 className="font-semibold text-blue-600 dark:text-blue-300">Troposfera</h4>
                  <span className="text-sm text-gray-500 dark:text-slate-400">0-12 km</span>
                </div>
              ...
              <div className="p-4 bg-gradient-to-r from-cyan-100/50 to-cyan-200/30 dark:from-cyan-900/30 dark:to-cyan-800/20 rounded-xl border border-cyan-500/20">
                <div className="flex justify-between items-center mb-2">
                  <h4 className="font-semibold text-cyan-600 dark:text-cyan-300">Estratosfera</h4>
                  <span className="text-sm text-gray-500 dark:text-slate-400">12-50 km</span>
                </div>
                <p className="text-sm text-gray-600 dark:text-slate-400">
              ...
              <div className="p-4 bg-gradient-to-r from-indigo-100/50 to-indigo-200/30 dark:from-indigo-900/30 dark:to-indigo-800/20 rounded-xl border border-indigo-500/20">
                <div className="flex justify-between items-center mb-2">
                  <h4 className="font-semibold text-indigo-600 dark:text-indigo-300">Mesosfera</h4>
                  <span className="text-sm text-gray-500 dark:text-slate-400">50-80 km</span>
                </div>
                <p className="text-sm text-gray-600 dark:text-slate-400">
              ...
              <div className="p-4 bg-gradient-to-r from-purple-100/50 to-purple-200/30 dark:from-purple-900/30 dark:to-purple-800/20 rounded-xl border border-purple-500/20">
                <div className="flex justify-between items-center mb-2">
                  <h4 className="font-semibold text-purple-600 dark:text-purple-300">Termosfera</h4>
                  <span className="text-sm text-gray-500 dark:text-slate-400">80-700 km</span>
                </div>
                <p className="text-sm text-gray-600 dark:text-slate-400">
              ...
              <div className="p-4 bg-gradient-to-r from-gray-100/50 to-gray-200/30 dark:from-slate-800/30 dark:to-slate-700/20 rounded-xl border border-slate-500/20">
                <div className="flex justify-between items-center mb-2">
                  <h4 className="font-semibold text-gray-700 dark:text-slate-300">Exosfera</h4>
                  <span className="text-sm text-gray-500 dark:text-slate-400">700-10.000 km</span>
                </div>
                <p className="text-sm text-gray-600 dark:text-slate-400">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-3 mb-8">
              <div className="p-3 bg-purple-500/20 rounded-xl">
                <GiMagnet className="text-3xl text-purple-600 dark:text-purple-400" />
              </div>
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Campo Magnético</h2>
            </div>

            <div className="space-y-6 text-gray-700 dark:text-slate-300 leading-relaxed">
              <p>
                O <strong className="text-purple-600 dark:text-purple-400">campo geomagnético</strong> é gerado pelo movimento 
                do ferro líquido no núcleo externo — um processo chamado <strong className="text-purple-600 dark:text-purple-300">geodínamo</strong>. 
                Este campo se estende milhares de quilômetros no espaço, formando a 
                <strong className="text-purple-600 dark:text-purple-400"> magnetosfera</strong>.
              </p>

              <div className="grid md:grid-cols-2 gap-6 my-8">
                <div className="p-5 bg-purple-500/10 rounded-xl border border-purple-500/20">
                  <h3 className="text-lg font-semibold text-purple-600 dark:text-purple-400 mb-3">Características</h3>
                ...
                <div className="p-5 bg-indigo-500/10 rounded-xl border border-indigo-500/20">
                  <h3 className="text-lg font-semibold text-indigo-600 dark:text-indigo-400 mb-3">Funções Vitais</h3>
                  <ul className="space-y-2 text-sm">
              ...
              <div className="p-6 bg-gradient-to-r from-purple-500/10 to-indigo-500/10 rounded-2xl border border-purple-500/20">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">🌌 Auroras</h3>
                <p>
                  ...
                  <strong className="text-green-600 dark:text-green-400"> auroras boreais</strong> (norte) e 
                  <strong className="text-green-600 dark:text-green-400"> austrais</strong> (sul). O oxigênio emite 
        ...
        <section className="py-20 px-4 bg-gray-200/50 dark:bg-slate-800/30">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-3 mb-8">
              <div className="p-3 bg-cyan-500/20 rounded-xl">
                <FaWater className="text-3xl text-cyan-600 dark:text-cyan-400" />
              </div>
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Hidrosfera: O Mundo das Águas</h2>
            </div>

            <div className="space-y-6 text-gray-700 dark:text-slate-300 leading-relaxed">
              <p>
                A <strong className="text-cyan-600 dark:text-cyan-400">hidrosfera</strong> engloba toda a água do planeta — 
                um volume estimado de <strong className="text-cyan-600 dark:text-cyan-300">1,386 bilhões de km³</strong>. 
              ...
              <div className="grid sm:grid-cols-3 gap-4 my-8">
                <div className="text-center p-5 bg-blue-500/10 rounded-xl border border-blue-500/20">
                  <div className="text-3xl font-bold text-blue-600 dark:text-blue-400">97,5%</div>
                  <div className="text-gray-600 dark:text-slate-400 text-sm mt-1">Água Salgada</div>
                  <div className="text-gray-500 dark:text-slate-500 text-xs">Oceanos e mares</div>
                </div>
                <div className="text-center p-5 bg-cyan-500/10 rounded-xl border border-cyan-500/20">
                  <div className="text-3xl font-bold text-cyan-600 dark:text-cyan-400">2,5%</div>
                  <div className="text-gray-600 dark:text-slate-400 text-sm mt-1">Água Doce</div>
                  <div className="text-gray-500 dark:text-slate-500 text-xs">Gelo, rios, lagos, aquíferos</div>
                </div>
                <div className="text-center p-5 bg-teal-500/10 rounded-xl border border-teal-500/20">
                  <div className="text-3xl font-bold text-teal-600 dark:text-teal-400">0,3%</div>
                  <div className="text-gray-600 dark:text-slate-400 text-sm mt-1">Acessível</div>
                  <div className="text-gray-500 dark:text-slate-500 text-xs">Água doce líquida de superfície</div>
                </div>
              </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="flex items-center gap-3 mb-12 justify-center">
              <div className="p-3 bg-green-500/20 rounded-xl">
                <FaGlobeAmericas className="text-3xl text-green-600 dark:text-green-400" />
              </div>
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Por Que a Terra é Especial?</h2>
            </div>

            <div className="grid md:grid-cols-2 gap-6">
              <div className="p-6 bg-gradient-to-br from-green-500/10 to-teal-500/10 rounded-2xl border border-green-500/20">
                <h3 className="text-lg font-semibold text-green-600 dark:text-green-400 mb-3">🌡️ Zona Habitável</h3>
              ...
              <div className="p-6 bg-gradient-to-br from-blue-500/10 to-cyan-500/10 rounded-2xl border border-blue-500/20">
                <h3 className="text-lg font-semibold text-blue-600 dark:text-blue-400 mb-3">🛡️ Atmosfera Protetora</h3>
                <p className="text-gray-700 dark:text-slate-300 text-sm">
              ...
              <div className="p-6 bg-gradient-to-br from-purple-500/10 to-indigo-500/10 rounded-2xl border border-purple-500/20">
                <h3 className="text-lg font-semibold text-purple-600 dark:text-purple-400 mb-3">🧲 Escudo Magnético</h3>
                <p className="text-gray-700 dark:text-slate-300 text-sm">
              ...
              <div className="p-6 bg-gradient-to-br from-amber-500/10 to-orange-500/10 rounded-2xl border border-amber-500/20">
                <h3 className="text-lg font-semibold text-amber-600 dark:text-amber-400 mb-3">🌙 Lua Estabilizadora</h3>
                <p className="text-gray-700 dark:text-slate-300 text-sm">
              ...
              <div className="p-6 bg-gradient-to-br from-cyan-500/10 to-blue-500/10 rounded-2xl border border-cyan-500/20">
                <h3 className="text-lg font-semibold text-cyan-600 dark:text-cyan-400 mb-3">🌊 Tectônica Ativa</h3>
                <p className="text-gray-700 dark:text-slate-300 text-sm">
              ...
              <div className="p-6 bg-gradient-to-br from-emerald-500/10 to-green-500/10 rounded-2xl border border-emerald-500/20">
                <h3 className="text-lg font-semibold text-emerald-600 dark:text-emerald-400 mb-3">🪐 Júpiter Guardião</h3>
                <p className="text-gray-700 dark:text-slate-300 text-sm">
...
IntroducaoPlanetaTerra.noLayout = true;
